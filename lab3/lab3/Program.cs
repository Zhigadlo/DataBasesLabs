...
app.UseEndpoints(endpoints =>
{
    ...
    endpoints.Map("/info", (context) => context.Response.WriteAsync($"<h1>User: {context.User}</h1>"));
    endpoints.MapGet("/dishes", (context) =>
    {
        CachedDishesService cachedTanksService = context.RequestServices.GetService<CachedDishesService>();
        ...
        IEnumerable<Dish> dishes = cachedTanksService.GetDishes("Dishes20");
